...
export default {
  ...
  methods: {
    ...
    async goToStore (offerId) {
      try {
        const { data: offer } = await this.$axios.get(`https://api.allorigins.win/raw?url=https://raw.githubusercontent.com/EpicData-info/offers-tracker/master/database/offers/${offerId}.json`);
